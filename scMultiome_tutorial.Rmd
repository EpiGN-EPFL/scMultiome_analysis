...
S1 and S2 refers to the the same biological sample but were sequenced across two different lanes. We can see that there are three paired RNA+ATAC datasets: two CRISPR knockouts and one control. Each pair corresponds to a specific sample ID:
